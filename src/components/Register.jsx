...
import RegisterImage from "../assets/images/LoginImage.webp";


const Register = ({ email, setEmail, password, setPassword, handleRegister, error, loading }) => {
    return (
        <section className="h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
            ...
            <div className="md:w-1/3 max-w-sm">
                ...
                <div className="text-center md:text-left">
                    <button
                        className={`mt-4 bg-blue-400 hover:bg-blue-500 px-4 py-2 text-white uppercase rounded text-xs tracking-wider ${loading ? 'opacity-50 cursor-not-allowed' : ''} w-5/12 h-10`} // Thêm lớp cho trạng thái loading
                        type="submit"
